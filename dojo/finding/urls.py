...
urlpatterns = [
    ...
    re_path(r'^finding/open$', views.open_findings,
        name='open_findings'),
    re_path(r'^finding/(?P<pid>\d+)(?P<scantype>\w+)/open$', views.product_types_open_findings,
        name='product_types_findings'),
    re_path(r'^finding/open$', views.verified_findings,
        name='verified_findings'),
    re_path(r'^product/(?P<pid>\d+)/finding/open$', views.open_findings,
        name='product_open_findings'),
    re_path(r'^product/(?P<pid>\d+)(?P<scantype>\w+)/finding/open$', views.product_open_findings,
        name='product_findings'),
    ...
    re_path(r'^product/(?P<pid>\d+)/finding/all$', views.open_findings, {'view': 'All'},
    ...
    re_path(r'^engagement/(?P<eid>\d+)/finding/all$', views.open_findings, {'view': 'All'},
