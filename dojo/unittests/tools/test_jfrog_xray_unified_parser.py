...
class TestJFrogXrayUnifiedParser(TestCase):

    def test_parse_file_with_no_vuln(self):
        testfile = open("dojo/unittests/scans/jfrog_xray_unified/no_vuln.json")
    ...
    def test_parse_file_with_one_vuln(self):
        testfile = open("dojo/unittests/scans/jfrog_xray_unified/one_vuln.json")
        parser = JFrogXrayUnifiedParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
        ...
        self.assertEqual("CVE-2020-28493", item.cve)
    ...
    def test_parse_file_with_very_many_vulns(self):
        testfile = open("dojo/unittests/scans/jfrog_xray_unified/very_many_vulns.json")
        parser = JFrogXrayUnifiedParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
        ...
        self.assertEqual("CVE-2016-10745", item.cve)
        ...
        self.assertEqual("CVE-2019-17006", item.cve)
        ...
        self.assertEqual("CVE-2020-14062", item.cve)
        self.assertIsNotNone(item.mitigation)
        self.assertGreater(len(item.mitigation), 0)

        # multiple fixed versions
        item = [i for i in findings if i.title[:11] == "XRAY-127258"][-1]
        self.assertEqual("CVE-2020-27216", item.cve)
        self.assertIsNotNone(item.mitigation)
        ...
        self.assertEqual("CVE-2020-1971", item.cve)
        ...
        self.assertEqual("CVE-2014-0047", item.cve)
        ...
        self.assertEqual("CVE-2020-11023", item.cve)
        ...
        self.assertEqual("CVE-2018-20225", item.cve)
        ...
        self.assertEqual("CVE-2019-19645", item.cve)
