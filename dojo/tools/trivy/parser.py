...
class TrivyParser:
    ...
    def get_findings(self, scan_file, test):
        ...
        items = list()
        image_name = data["ArtifactName"] if "ArtifactName" in data else "NA"
        ...
        for target_data in results:
            ...
            for vuln in vulnerabilities:
                ...
                description = DESCRIPTION_TEMPLATE.format(
                    ...
                    description_text="Image name: " + image_name + " " + vuln.get('Description', ''),
                )
                ...
                host_name = image_name.replace("/",".").replace(":","/")
                finding = Finding(
                        test=test,
                        title=title,
                        cve=vuln_id,
                        ...
                        vuln_id_from_tool=" ".join([host_name, vuln_id, package_name, package_version, mitigation]),
                        unique_id_from_tool=" ".join([host_name, vuln_id, package_name, package_version, mitigation]),
