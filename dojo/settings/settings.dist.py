...
HASHCODE_FIELDS_PER_SCANNER = {
    ...
    'Cloudsploit Scan': ['description', 'title'],
    'Pingsafe Scan': ['unique_id_from_tool']
}
...
DEDUPLICATION_ALGORITHM_PER_PARSER = {
    ...
    'Trivy Scan': DEDUPE_ALGO_UNIQUE_ID_FROM_TOOL,
    ...
    'Dependabot Scan': DEDUPE_ALGO_UNIQUE_ID_FROM_TOOL,
    ...
    'Semgrep JSON Report': DEDUPE_ALGO_UNIQUE_ID_FROM_TOOL,
    'Pingsafe Scan': DEDUPE_ALGO_UNIQUE_ID_FROM_TOOL
}
...
VISIBLE_TOOLS_NAME = {"Dependabot Scan":"dependabot", "Semgrep JSON Report":"semgrep", 
                      "Trivy Scan":"trivy",
                      "Pingsafe Scan":"pingsafe"
                    #   "Burp Scan":"burp", 
                    #   "Fortify Scan":"fority", "Qualys Scan":"qualys", 
                    #   "Nessus Scan":"nessus", "Dependency Check Scan":"dependency_check", 
                    #   "ZAP Scan":"zap"
                      }
