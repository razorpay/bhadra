...
class JiraIssuesViewSet(mixins.ListModelMixin,
    ...
    filter_backends = (DjangoFilterBackend,)
    filterset_fields = ('id', 'jira_id', 'jira_key', 'finding_id')
    permission_classes = (IsAdminUser, DjangoModelPermissions)
...
class JiraProjectViewSet(mixins.ListModelMixin,
    ...
    filter_backends = (DjangoFilterBackend,)
    filterset_fields = ('id', 'jira_instance', 'product', 'component', 'project_key',
...
class SonarqubeProductViewSet(mixins.ListModelMixin,
    ...
    filter_backends = (DjangoFilterBackend,)
    filterset_fields = ('id', 'product', 'sonarqube_project_key',
