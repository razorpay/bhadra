...
from dojo.filters import ProductEngagementFilter, ProductFilter, EngagementFilter, MetricsEndpointFilter, MetricsFindingFilter, ProductComponentFilter,OpenFindingFilter
from dojo.forms import ProductForm, EngForm, DeleteProductForm, DojoMetaDataForm, JIRAProjectForm, JIRAFindingForm, AdHocFindingForm, \
                       ...
                       DeleteAppAnalysisForm, DeleteSonarqubeConfigurationForm,FindingBulkUpdateForm
...
from dojo.utils import add_external_issue, add_error_message_to_response, add_field_errors_to_response, get_page_items, add_breadcrumb, \
                       get_system_setting, Product_Tab, get_punchcard_data, queryset_check, is_title_in_breadcrumbs,get_words_for_field
...
def view_product(request, pid):
    ...
    print("Going to call product findings ")
    findings_list=product_findings(request, pid=pid, eid=None, view=None, filter_name="Open", query_filter=finding_helper.OPEN_FINDINGS_QUERY, prefetch_type='open')
...
#custom method to fetch findings for product view
...
def product_findings(request, pid=None, eid=None, view=None, filter_name=None, query_filter=None, order_by='numerical_severity',
django_filter=open_findings_filter, prefetch_type='all'):
    ...
    if pid:
        ...
        print("DOJO/PRODUCT PID not exists")
