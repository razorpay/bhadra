...
urlpatterns = [
    ...
    re_path(r'^product/(?P<pid>\d+)/add_sonarqube', views.add_sonarqube,
        name='add_sonarqube'),
    re_path(r'^product/(?P<pid>\d+)/view_sonarqube$', views.view_sonarqube,
        name='view_sonarqube'),
    re_path(r'^product/(?P<pid>\d+)/edit_sonarqube/(?P<sqcid>\d+)', views.edit_sonarqube,
        name='edit_sonarqube'),
    re_path(r'^product/(?P<pid>\d+)/delete_sonarqube/(?P<sqcid>\d+)$', views.delete_sonarqube,
