...
# 'last_reviewed','sourcefilepath','risk_acceptance','out_of_scope','has_component','has_notes',
# 'file_path','unique_id_from_tool','vuln_id_from_tool','test__engagement__version','test__version',
# 'test__engagement__product__prod_type','test__engagement__product',, 'component_name', 'component_version'
#'date','cve','cwe','severity','last_status_update',                'test__engagement','test', 'param',
# 'payload',                'false_p','risk_accepted'
...
class FindingFilter(FindingFilterWithTags):
    ...
    class Meta:
        ...
        exclude = ['url', 'description', 'mitigation', 'impact',
                   ...
                   'Is Grouped', 'Has Component' , 'Has notes', 
                   'Product without tags' ,'Engagement without tags',
                   'Out Of Scope', 'Engagement Version','Unique ID from tool', 
                   'Vulnerability ID from tool','Source File Path contains',
                   'Parameter contains','File path contains','Last Reviewed',
                   'CWE','Payload contains']
